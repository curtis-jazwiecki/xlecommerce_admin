    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="1" bgcolor="#EEEEEE">
     ...
     <tr class="dataTableHeadingRow">
      ...
      <!-- Begin of Header Tags - Add a Page -->
        ...
        <tr>
          <td class="main" style="color:#000000"><?php echo TEXT_INFORMATION_ADD_PAGE; ?></td>
        </tr>
       <tr>
         <td align="right" style="color:#000000"><?php echo tep_draw_form('header_tags', FILENAME_HEADER_TAGS_CONTROLLER, '', 'post') . tep_draw_hidden_field('action', 'process'); ?></td>
       </tr>
       <tr>
     ...
     <!-- Begin of Header Tags - Delete a Page -->
         ...
         <tr>
           <td class="main" style="color:#000000"><?php echo TEXT_INFORMATION_DELETE_PAGE; ?></td>
         </tr>     
         <tr>
     ...
     <!-- Begin of Header Tags - Auto Add Pages -->
           ...
           <tr>
             <td class="main" style="color:#000000"><?php echo TEXT_INFORMATION_CHECK_PAGES; ?></td>
           </tr>     
           <tr>
