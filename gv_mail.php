...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2" bgcolor="#EEEEEE">
...
?>
              <tr>
                <td class="main" style="color:#000000"><?php echo TEXT_CUSTOMER; ?></td>
              ...
              <tr>
               ...
               <tr>
                <td class="main" style="color:#000000"><?php echo TEXT_TO; ?></td>
                <td style="color:#000000"><?php echo tep_draw_input_field('email_to'); ?><?php echo '&nbsp;&nbsp;' . TEXT_SINGLE_EMAIL; ?></td>
              </tr>
              <tr>
                <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
              </tr>
             <tr>
                <td class="main" style="color:#000000"><?php echo TEXT_FROM; ?></td>
              ...
              <tr>
                <td class="main" style="color:#000000"><?php echo TEXT_SUBJECT; ?></td>
              ...
              <tr>
                <td valign="top" class="main" style="color:#000000"><?php echo TEXT_AMOUNT; ?></td>
              ...
              <tr>
                <td valign="top" class="main" style="color:#000000"><?php echo TEXT_MESSAGE; ?></td>
