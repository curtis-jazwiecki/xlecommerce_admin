							...
							<table border="0" width="100%" cellspacing="0" cellpadding="2">
								...
								<?php
    								...
    								if (isset($HTTP_GET_VARS['search'])) {
      									...
      									$categories_query = tep_db_query("select c.categories_id, cd.categories_name, c.categories_image, c.parent_id, c.sort_order, c.date_added, c.last_modified, c.categories_status, c.rectangle_image, c.square_image, cd.categories_htc_description from frontend_categories c, frontend_categories_description cd where c.categories_id = cd.categories_id and cd.language_id = '" . (int)$languages_id . "' and cd.categories_name like '%" . tep_db_input($search) . "%' order by c.sort_order, cd.categories_name");
    								} else {
