...
define('BOX_REPORTS_CREDITS', 'Current Customer Assets');
...
//END STS 4.1
// ####### Category Specials #######
define('BOX_CATALOG_CATEGORY_SPECIALS', 'Special Categories');
...
define('BOX_CATALOG_XSELL_PRODUCTS', 'Related Products');
define('BOX_CATALOG_GOOGLESITEMAP', 'Google XML Sitemap');
//BOF RANGE MANAGER 25-DEC-MANAGER
define('BOX_CATALOG_RANGEMANAGER', 'Range Manager');
define('BOX_CATALOG_LANESMANAGER', 'Lanes Manager');
//EOF RANGE MANAGER 25-DEC-MANAGER
define('BOX_TOOLS_PACKAGING', 'Packaging');

define('BOX_CUSTOMERS_GROUPS', 'Customers Groups');

define('FRAUD_PREVENTION_NOTIFICATION', '<html><head></head><body><table style="width:100%"><tr><td style="text-align: center;">This order has criteria which may be considered possible fraud, before processing this order and shipping product it is recommended that you take steps to verify this order is legitimate.</td></tr><tr><td style="text-align: center;" ><input type="button" value="OK" onclick="javascript:window.close();" /></td></tr></table></body></html>');
