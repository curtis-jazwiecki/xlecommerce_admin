...
define('TEXT_BANNERS_NEW_GROUP', '<span> or enter a new banner group below</span>');
define('TEXT_BANNERS_IMAGE', 'Image:');
define('TEXT_BANNERS_IMAGE_LOCAL', '<span> or enter local file below</span>');
define('TEXT_BANNERS_IMAGE_TARGET', 'Image Target (Save To):');
define('TEXT_BANNERS_HTML_TEXT', 'HTML Text:');
define('TEXT_BANNERS_EXPIRES_ON', 'Expires On:');
define('TEXT_BANNERS_OR_AT', '<span> or at</span>');
define('TEXT_BANNERS_IMPRESSIONS', '<span> impressions/views.</span>');
