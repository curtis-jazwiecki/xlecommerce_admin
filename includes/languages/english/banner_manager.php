...
define('HEADING_TITLE', 'Banner Manager for Templates');
...
define('TEXT_BANNERS_NEW_GROUP', '<span style="color:#FFFFFF"> or enter a new banner group below</span>');
define('TEXT_BANNERS_IMAGE', 'Image:');
define('TEXT_BANNERS_IMAGE_LOCAL', '<span style="color:#FFFFFF"> or enter local file below</span>');
define('TEXT_BANNERS_IMAGE_TARGET', 'Image Target (Save To):');
define('TEXT_BANNERS_HTML_TEXT', 'HTML Text:');
define('TEXT_BANNERS_EXPIRES_ON', 'Expires On:');
define('TEXT_BANNERS_OR_AT', '<span style="color:#FFFFFF"> or at</span>');
define('TEXT_BANNERS_IMPRESSIONS', '<span style="color:#FFFFFF"> impressions/views.</span>');
