          ...
          <tr>
			...
			<input type="hidden" name="action" value="update_countries" />
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent" width="130px">Active Country</td>
                <td class="dataTableHeadingContent" width="50px" align="center"><?php echo TABLE_HEADING_ACTION; ?>&nbsp;</td>
              </tr>
<?php
...
?>
          <tr bgcolor="#DDDDDD">
            ...
            <td class="dataTableContent" align="center" width="40"><b><?php echo $countries_array_iso_code_2[$z]; ?></b></td>
            <td class="dataTableContent" align="center" width="40"><b><?php echo $countries_array_iso_code_3[$z] ?></b></td>
            <td class="dataTableContent" align="left"><b>
            <input type="radio" name="<?php echo $countries_array_id[$z]; ?>" value="true" checked />Yes
            ...
            <td class="dataTableContent" align="center"><a href="<?php echo $_SERVER['PHP_SELF'] . "?action=edit&t=on&id=" . $countries_array_id[$z];?>" style="color: #222222">Edit</a></td>
          </tr>
<?php
	  }
...
?>
          <tr bgcolor="#DDDDDD">
            ...
            <td class="dataTableContent" align="center" width="40"><?php echo $countries_array_off_iso_code_2[$z]; ?></td>
            <td class="dataTableContent" align="center" width="40"><?php echo $countries_array_off_iso_code_3[$z] ?></td>
            <td class="dataTableContent" align="left"><b>
            <input type="radio" name="<?php echo $countries_array_off_id[$z]; ?>" value="true" />Yes
            <input type="radio" name="<?php echo $countries_array_off_id[$z]; ?>" value="false" checked />No
            ...
            <td class="dataTableContent" align="center"><a href="<?php echo $_SERVER['PHP_SELF'] . "?action=edit&t=off&id=" . $countries_array_off_id[$z];?>" style="color: #222222">Edit</a></td>
          </tr>
<?php
	  }
?>
              ...
              <tr><td>
              <?php echo sizeof($countries_array_id).'<br />'.sizeof($countries_array_off_id); ?>
              </td></tr>
            </table></td>
<?php
	if($_GET['action'] == 'edit')
