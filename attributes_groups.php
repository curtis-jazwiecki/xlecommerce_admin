...
<?php echo '<p style="margin-top: 20px;">' . tep_draw_button(IMAGE_SAVE, 'disk', null, 'primary', array('params'=>'name="submitbutton"', 'type'=>'image')) . tep_draw_hidden_field('submitbutton_x', 'true') . '&#160;' . tep_draw_button(IMAGE_CANCEL, 'close', null, null, array('params'=>'onclick=\'self.close()\'')) .'</p>' . "\n";
?>
</form>
</div>
<?php
