...
/**
 * FBAInboundServiceMWS_Model_ErrorResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>Error: FBAInboundServiceMWS_Model_Error</li>
 * <li>RequestId: string</li>
 *
 * </ul>
 */ 
class FBAInboundServiceMWS_Model_ErrorResponse extends FBAInboundServiceMWS_Model
{


    /**
     * Construct new FBAInboundServiceMWS_Model_ErrorResponse
     * 
    ...
    {
        $this->_fields = array (
        'Error' => array('FieldValue' => array(), 'FieldType' => array('FBAInboundServiceMWS_Model_Error')),
    ...
    /**
     * Construct FBAInboundServiceMWS_Model_ErrorResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return FBAInboundServiceMWS_Model_ErrorResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FBAInboundServiceMWS_Model_ErrorResponse(($response->item(0))); 
        } else {
            throw new Exception ("Unable to construct FBAInboundServiceMWS_Model_ErrorResponse from provided XML. 
     ...
     * @return FBAInboundServiceMWS_Model_ErrorResponse  instance
     */
    ...
    {
        $xml = "";
        $xml .= "<ErrorResponse xmlns=\"http://mws.amazonaws.com/FulfillmentInboundShipment/2010-10-01/\">";
