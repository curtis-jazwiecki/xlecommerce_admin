...
class amDB {
	 ...
	 * @return array
	 */
	static function fetchArray($ref) {
	 ...
	 * @return void
	 */
	static function perform($strTable,$arrData,$strAction='insert',$strParams='') {
	 ...
	 */
	static function getAll($strQuery) {
		$res = amDB::query($strQuery);
		$results = array();
	 ...
	 * @return mixed
	 */
	static function getNextAutoValue($strTable,$strField) {
