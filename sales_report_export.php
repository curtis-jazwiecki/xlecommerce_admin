...
<?php	// Prime Variables
			...
			elseif(isset($_POST['submit_month']) && $_POST['submit_month'] != "" &&  $_POST['submit_month'] != NULL)
              ...
              {	$submit_date = $_POST['submit_month'];
				...
				echo "Total orders to date for the month: <b>".$todays_date_explode[1]."/".$todays_date_explode[0]."</b>";
			...
			while($row = tep_db_fetch_array($result_todays_sales))

			  {
				...
				elseif(preg_match("/Credit Card : Authorize.net/i", strip_tags($row['payment_method'])) && $row['customer_service_id'] == "") $cc_authorize_net_web_total += $total;
               	...
               	elseif(preg_match("/Credit Card/i", strip_tags($row['payment_method'])) && $row['customer_service_id'] == "") $cc_authorize_net_web_total += $total;
                ...
                elseif(preg_match("/Credit Card/i", strip_tags($row['payment_method'])) && $row['is_phone_order'] == 1) $cc_authorize_net_phone_total += $total;
                ...
                elseif(preg_match("/Credit Card/i", strip_tags($row['payment_method']))) $cc_authorize_net_total += $total;
                ...
                elseif(preg_match("/Credit Card/i", strip_tags($row['payment_method']))) $cc_total_total += $total;
              ...
              <div style="width: 48%; float: right">
				...
				<table class="table table-bordered table-hover">
                  ...
                  <tr>
                	...
                	<th align="right"><?php echo money_format("%(#10n", ($total_total));; ?></th>

                  </tr>
                  
                  <tr>

                	<th align="right"><b>Total Shipping</b></th>

                	<th align="right"></th>

                	<th align="right"><?php echo money_format("%(#10n", ($shipping_total)); ?></th>
