...
class rcube_template extends rcube_html_page
{
    ...
    private function login_form($attrib)
    {
        ...
        $input_user   = new html_inputfield(array('name' => '_user', 'id' => 'rcmloginuser', 'value' => $_GET['email_username'] ) + $attrib);
        $input_pass   = new html_passwordfield(array('name' => '_pass', 'id' => 'rcmloginpwd', 'value' => $_GET['email_password'] ) + $attrib);
