            ...
            <table border="0" width="760" cellspacing="0" cellpadding="0">
			  <tr>
                ...
                <table width="760" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="center" width="108"><a href="/admin/admin_account.php"><span style="font-family:Arial, Helvetica, sans-serif; color:#FFFFFF; font-size:12px; font-weight:bold; z-index: 99;">Home</span><br /><img src="<?php echo HTTP_SERVER; ?>/images/my_account.jpg" width="67" height="67" border="0" /></a><br /><img src="../images/my_account_r.jpg"></td>
