...
?></td>
		 ...
		 <input type="hidden" name="products_specifications[<?php echo $languages[$i]['id']; ?>]" value="<?php echo (isset($products_specifications[$languages[$i]['id']]) ?
...
?>
    ...
    ?>
	   ...
	   $x = 0;
		...
		foreach ($specifications as $specification){ $x++; ?>
...
if( (isset($_GET['update_options'])) && ($_GET['update_options'] == '1') ){?>
