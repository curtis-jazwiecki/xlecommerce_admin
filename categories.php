                                 ...
                                 <!--<tr>
                                                                ...
                                                                <div id="tabs-5">
                                                                    ...
                                                                    <table class="table table-bordered table-hover">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php
                                                                            $qpu_price = get_qpu_price($pInfo->base_price, $pInfo->markup, $pInfo->roundoff_flag);

                                                                                echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;';

                                                                                ?>
                                                                      <input type="text" name="qpu_price" value="<?php echo (int) $pInfo->base_price <= 0 ? '' : $qpu_price; ?>" readonly></td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php
                                                                                ...
                                                                                echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;';?>
                                                                                <input type="text" name="products_price" value="<?php echo $pInfo->products_price;?>" readonly></td>
                                  ...
                                  <?php
                                       if ($_GET['pID'] && $_GET['pID'] > 0) {
                                         $price_query = tep_db_query("select unit_cost, unit_msrp, min_acceptable_price from products_extended where osc_products_id = '" . (int)$_GET['pID'] . "'");
                                         $price_result = tep_db_fetch_array($price_query);
                                    ?>
                                     <tr> <td colspan="2"><b>Prices from OBN Feed:</b></td>                                         
                                      </tr>
                                      <?php if ($price_result['unit_cost'] > 0) { ?>
                                     <tr> <td>Unit cost:</td>
                                          <td><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $price_result['unit_cost']; ?></td>
                                      </tr> 
                                      <?php }
                                        if ($price_result['unit_msrp'] > 0) { ?>                                    
                                      <tr> <td>MSRP:</td>
                                          <td><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $price_result['unit_msrp']; ?></td>
                                      </tr>
                                      <?php }
                                      if ($price_result['min_acceptable_price'] > 0) { ?>
                                       <tr> <td>Min Advertised Price:</td>
                                          <td><?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $price_result['min_acceptable_price']; ?></td>
                                      </tr> 
                                      <?php } ?>
                                      <?php } ?> 
                                                                    </table>
