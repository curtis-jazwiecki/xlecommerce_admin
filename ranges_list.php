...
<tr class="dataTableHeadingRow">
	...
	<td align=center class="dataTableHeadingContent">LOGO</td>
	<!--EOF RANGE LOGO 09-JAN-2014-->
    <td align=center class="dataTableHeadingContent"><?php echo VIEW_LANES;?></td>
    <td align=center class="dataTableHeadingContent"><?php echo CALCULATE_VIA;?></td>
...
?>
  <tr bgcolor="<?php echo $bgcolor?>">
    ...
    <td width="40%" class="dataTableContent"><?php echo $val['ranges_name'];?></td>
    <td width="40%" class="dataTableContent"><?php if($val['logo']) {?><img src="<?php echo RANGE_LOGO.$val['logo'];?>" width="100"  height="100"><?php } else echo ' ';?></td>
    <td width="40%" class="dataTableContent"><?php echo '<a style="text-decoration:underline;color:#000;" href="' . tep_href_link(FILENAME_LANES_MANAGER, "ranges_id=".$val['ranges_id'], 'NONSSL') . '">'.VIEW_LANES.'</a>';?></td>
    <td width="40%" class="dataTableContent"><?php echo $val['calculate_via'];?></td>
...
?>
   <tr bgcolor="#DEE4E8">
    <td colspan="8" class="dataTableContent"><?php echo ALERT_INFORMATION;?></td>
   </tr>
<?php
}
?>
